...
Namespace ControlProcess
    ...
    Public Class TableUpdateControlProcess
        ...
        Public Shared Function Import(ByVal dbAccessor As DbAccessor, ByVal masterSetting As MasterSetting,
            ...
            If HasUnprocessedData(masterSetting.Name, dataformatSettingList, updateMasterSettingList) Then
                ErrorUtility.OutputErrorLog(ExistUnprocessedData)
            ...
            ImportFile(dbAccessor, masterSetting, showMessage)
            Return ProcessResult.Success
        End Function

        Private Shared Sub ImportFile(ByVal dbAccessor As DbAccessor, ByVal masterSetting As MasterSetting, ByVal showMessage As Boolean)
            ...
            Try
                ...
                If Not String.IsNullOrEmpty(errorMessage) Then
                    If ((result And ImportResult.Failure) = ImportResult.Failure) Then
                        ...
                        ErrorUtility.OutputErrorLog(errorMessage)
        ...
        Private Shared Sub BackupSourceFile(ByVal importFilePath As String)
            ...
            Catch ex As Exception
                ErrorUtility.OutputErrorLog(String.Format(ErrorLogBackupImportFileFailed, Path.GetFileName(importFilePath)))
